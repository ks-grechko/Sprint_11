...
if (event.target.classList.contains(addPlacePopUp.button)) {
...
root.addEventListener("click", likeEvent);
root.addEventListener("click", deliteCard);
root.addEventListener("click", openPhoto);
root.addEventListener("click", EditPopUp);
root.addEventListener("click", AddCardPopUp);
